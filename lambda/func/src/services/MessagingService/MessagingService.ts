...
export class MessagingService {
	...
	constructor() {
		...
		this._cloudWatch = {
			...
			VALID_SEMANTIC_VERSION: 'The provided semantic version %0 is valid',
			VALID_COMPILER_FLAGS: 'The provided compiler flags %0 are valid',
		};
		...
		this._handler = {
			...
			EVENT_INVALID: 'The request body failed validation with errors',
		};
